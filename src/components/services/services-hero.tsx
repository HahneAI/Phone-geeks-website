  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-16 lg:pt-20">
        ...
        <h1 className="mt-6 max-w-2xl text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl">
          Services &amp; pricing
        </h1>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/70">
          Straightforward pricing, real turnaround times, no surprise fees.
          Every repair is backed by our 1-year warranty on parts and labor.
        </p>
      </div>
    </section>
  );
